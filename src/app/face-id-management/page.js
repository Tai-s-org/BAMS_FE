                    ...
                    {coaches.map((coach) => (
                        <Card key={coach.userId} className="overflow-hidden">
                            <CardHeader className="bg-gray-50 pb-4">
                                ...
                                <CardDescription>
                                    Mã đội: {coach.teamId} • Hợp đồng: {coach.contractStartDate} đến {coach.contractEndDate}
                                </CardDescription>
                            </CardHeader>
                    ...
                    {players.map((player) => (
                        <Card key={player.userId} className="overflow-hidden">
                            <CardHeader className="bg-gray-50 pb-4">
                                ...
                                <CardDescription>
                                    Mã đội: {player.teamId} • Vị trí: {player.position} • Ngày tham gia: {player.clubJoinDate}
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="pt-4">
                                <Button
